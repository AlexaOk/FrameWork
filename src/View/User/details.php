...
<p>Nom :<?php foreach ($details as $key => $value) {echo $value['name'];}?></p>
<p>Email : <?php foreach ($details as $key => $value) {echo $value['email'];}?></p>
<p>Date d'inscription : <?php foreach ($details as $key => $value) {echo $value['registrationDate'];}?></p>
